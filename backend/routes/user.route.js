...
import { getOtherUserDetail, getOtherUsers, loadUser, loginUser, logoutUser, registerUser } from '../controllers/user.controller.js';
...
router.route('/others/:id').get(isAuth, getOtherUserDetail);
